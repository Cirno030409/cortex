...
class Chunk_WTA:
    ...
    Methods:
        ...
        change_image(image:np.ndarray, spontaneous_rate:int=0): 入力画像を変更します。
    """
    def __init__(self, enable_monitor:bool, n_inp, n_e, n_i, max_rate, neuron_params_1e, neuron_params_1i, neuron_params_2e, neuron_params_2i, static_synapse_params_1ei, static_synapse_params_1ie, static_synapse_params_2ei, static_synapse_params_2ie, stdp_synapse_params_1, stdp_synapse_params_2):
        # Make instances of neurons and synapses
        neuron_1e = Conductance_LIF(neuron_params_1e)
        neuron_1i = Conductance_LIF(neuron_params_1i)
        neuron_2e = Conductance_LIF(neuron_params_2e)
        neuron_2i = Conductance_LIF(neuron_params_2i)
        self.neuron_inp = Poisson_Input()
        synapse_1ei = NonSTDP(static_synapse_params_1ei)
        synapse_1ie = NonSTDP(static_synapse_params_1ie)
        synapse_2ei = NonSTDP(static_synapse_params_2ei)
        synapse_2ie = NonSTDP(static_synapse_params_2ie)
        synapse_1stdp = STDP(stdp_synapse_params_1)
        synapse_2stdp = STDP(stdp_synapse_params_2)
        self.obj = {} # ネットワークのオブジェクトを格納する辞書

        # Create network
        ## NeuronGroups
        self.obj["N_input"] = self.neuron_inp(n_inp, max_rate=max_rate, name="N_input")
        self.obj["N_1_exc"] = neuron_1e(n_e, name="N_1_exc")
        self.obj["N_1_inh"] = neuron_1i(n_i, name="N_1_inh")
        self.obj["N_2_exc"] = neuron_2e(n_e, name="N_2_exc")
        self.obj["N_2_inh"] = neuron_2i(n_i, name="N_2_inh")

        ## Synapses
        self.obj["S_0"] = synapse_1stdp(self.obj["N_input"], self.obj["N_1_exc"], name="S_0", connect=True) # 入力層から興奮ニューロン
        self.obj["S_1_ei"] = synapse_1ei(self.obj["N_1_exc"], self.obj["N_2_exc"], "exc", name="S_1_ei", delay=0*ms, connect="i==j") # 興奮ニューロンから抑制ニューロン
        self.obj["S_1_ie"] = synapse_1ie(self.obj["N_1_inh"], self.obj["N_2_exc"], "inh", name="S_1_ie", delay=0*ms, connect="i!=j") # 側抑制
        self.obj["S_1_2"] = synapse_2stdp(self.obj["N_1_exc"], self.obj["N_2_exc"], name="S_1_2", connect=True) # １層から２層目の接続
        self.obj["S_2_ei"] = synapse_2ei(self.obj["N_2_exc"], self.obj["N_1_exc"], "exc", name="S_2_ei", delay=0*ms, connect="i==j") # 興奮ニューロンから抑制ニューロン
        self.obj["S_2_ie"] = synapse_2ie(self.obj["N_2_inh"], self.obj["N_1_exc"], "inh", name="S_2_ie", delay=0*ms, connect="i!=j") # 側抑制
        ...
        if enable_monitor:
            ...
            self.obj["spikemon_2_exc"] = SpikeMonitor(self.obj["N_2_exc"], record=True, name="spikemon_2_exc")
            ...
            # self.obj["statemon_1"] = StateMonitor(self.obj["N_1"], ["v",  "Ie", "Ii", "ge", "gi"], record=50, name="statemon_1")
            # self.obj["statemon_S"] = StateMonitor(self.obj["S_0"], ["w", "apre", "apost"], record=0, name="statemon_S")
        self.obj["spikemon_for_assign"] = SpikeMonitor(self.obj["N_2_exc"], record=True, name="spikemon_for_assign") # ラベル割当に必要
