...
from Brian2_Framework.Preprocesses import Gabor_Filter


seed = 2
PARAMS_PATH = "Brian2_Framework/parameters/WTA_gabor/WTA_learn.json"
params = tools.load_parameters(PARAMS_PATH) # パラメータを読み込み

# ============================== 実験記録用パラメータ ==============================
test_comment = "Gaborフィルタを適用" #! 実験用コメント
...
tools.save_parameters(SAVE_PATH, params) # パラメータを保存

gabor = Gabor_Filter()
plotter = Plotters.Common_Plotter() # プロットを行うインスタンス
